              ...
              <div class="grid md:grid-cols-1 gap-1 posisi fixed-bottom">
                <div>
                  <center>
                    ...
                    <figure class="max-w-lg">
                      <a href="#">
                        <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/content/content-gallery-3.png" alt="product image" />
                      </a>
                    </figure>
                    <br />
                  </center>
                ...
                <div class="px-5 pb-5 text text-justify">
                  ...
                  <div class="flex items-center justify-between">
                    <span class="text-xl font-semibold text-gray-900 dark:text-white">Rp. {{ product.base_price }}</span>
                    <router-link :to="{ name: 'SingleProduct', params: { id: product.id } }" class="group text-md peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-3 py-1 font-bold">Detail...</router-link>
                  </div>
                </div>
              </div>
            </div>
